...
module.exports = {
  expo: {
    ...
    plugins: [
      ...
      "expo-font",
      "expo-video",
      // Signs locally built release APKs with the keystore EAS uses, which is what the
      // Google Maps key is restricted to. No-op unless ./credentials exists, so EAS
      // builds are unaffected. See plugins/withLocalReleaseSigning.js.
