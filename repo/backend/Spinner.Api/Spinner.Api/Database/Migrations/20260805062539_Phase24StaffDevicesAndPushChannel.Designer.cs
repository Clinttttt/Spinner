...
namespace Spinner.Api.Database.Migrations
{
    ...
    [Migration("20260805062539_Phase24StaffDevicesAndPushChannel")]
    partial class Phase24StaffDevicesAndPushChannel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Spinner.Api.Domain.Business.BusinessSettings", b =>
                {
                    ...
                    b.Property<decimal?>("PickupOriginLatitude")
                        .HasPrecision(10, 7)
                        .HasColumnType("numeric(10,7)");

                    b.Property<decimal?>("PickupOriginLongitude")
                        .HasPrecision(10, 7)
                        .HasColumnType("numeric(10,7)");

                    b.Property<decimal>("PickupServiceRadiusKm")
                        .HasPrecision(8, 2)
            ...
            modelBuilder.Entity("Spinner.Api.Domain.Payments.PendingBooking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PendingBookings", (string)null);
                });
            ...
            modelBuilder.Entity("Spinner.Api.Domain.Users.StaffDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Spinner.Api.Domain.Users.StaffInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Spinner.Api.Domain.Users.StaffInvitation", b =>
                {
                    b.HasOne("Spinner.Api.Domain.Users.StaffUser", null)
                        .WithMany()
