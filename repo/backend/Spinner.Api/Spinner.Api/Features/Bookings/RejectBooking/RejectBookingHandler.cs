...
public sealed class RejectBookingHandler : IRequestHandler<RejectBookingCommand, Result<OrderDetailsResponse>>
{
    private readonly AppDbContext _dbContext;

    public RejectBookingHandler(AppDbContext dbContext)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        var transition = order.Reject(DateTimeOffset.UtcNow);
        ...
        BookingNotificationQueue.QueueBookingRejected(_dbContext, order, settings.BusinessName, DateTimeOffset.UtcNow);
